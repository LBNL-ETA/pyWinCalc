...
PYBIND11_MODULE(wincalcbindings, m) {
    ...
    py::class_<Tarcog::ISO15099::SphericalPillar, Tarcog::ISO15099::PillarData,
            ...
            .def_readwrite("radius_of_contact", &Tarcog::ISO15099::SphericalPillar::radiusOfContact);
    ...
    py::class_<Tarcog::ISO15099::PolygonalPillar, Tarcog::ISO15099::PillarData,
            ...
            m, "PolygonalPillar")
            .def(py::init<double, double, double, double, Tarcog::ISO15099::PolygonType>(),
                 py::arg("height"), py::arg("material_conductivity"), py::arg("cell_area"), py::arg("length"),
                 py::arg("polygon_type"))
    ...
    py::class_<Tarcog::ISO15099::Layers>(m, "Layers")
            ...
            .def_static(
                    "create_pillar",
                    py::overload_cast<Tarcog::ISO15099::SphericalPillar const &,
                            double>(&Tarcog::ISO15099::Layers::createPillar),
