...
# This shows an example of how to create a vertical Venetian blind from a user-defined Venetian geometry
# and a material downloaded from igsdb.lbl.gov
...
# A Venetian blind requires a BSDF hemisphere.  Create one based on a standard quarter basis for this test
...
glazing_system = pywincalc.GlazingSystem(solid_layers=[venetian_layer],
                                                 bsdf_hemisphere=bsdf_hemisphere)

u_value = glazing_system.u()
print(
    "U-value for a vertical Venetian blind made from a user-defined geometry and material downloaded from igsdb.lbl.glv: {v}".format(
        v=u_value))
