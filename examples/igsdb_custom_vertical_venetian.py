...
is_horizontal = True  # Set is_horizontal to False in the geometry to make a vertical louver
...
results_name = "Results for a single-layer system with a custom vertical louver made from a material downloaded from the IGSDB and a user-defined geometry."
