"""
Tests for double layer clear glass (CLEAR_3 + air + CLEAR_3).

Based on WinCalc test pattern: 2_layers_nfrc_102_air_nfrc_102.unit.cpp
"""
import pytest
import pywincalc
...
class TestDoubleClearGlass:
    """Test suite for double layer clear glass with air gap."""
